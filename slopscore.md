...
category: [game]
status: beta
demo_url: https://clockwork-rush.ping6163.workers.dev
built_with: [claude-code]
models: [claude-opus-5]
interface: [web]
frameworks: [vanilla-js]
platforms: [browser, cloudflare, windows]
audience: [end-users]
data: [none]
...
The human wrote the game. The AI wrote the port. Both are in the repo.
